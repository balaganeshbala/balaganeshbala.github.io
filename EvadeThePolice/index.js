...
(function(exports) {
  ...
  var genericMkDyn = function (defaultValue) {
      return Unsafe_Coerce.unsafeCoerce(function __do() {
...
(function(exports) {
  ...
  var DOM_HTML_Event_HashChangeEvent = PS["DOM.HTML.Event.HashChangeEvent"];
  ...
  var view = function (action) {
      return function (state) {
          return PrestoDOM_Elements.frameLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.gravity("center"), PrestoDOM_Properties.name("rootNode") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(600)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(800)), PrestoDOM_Properties.background("#F0DD9F"), PrestoDOM_Properties.gravity("center"), PrestoDOM_Properties.orientation("horizontal") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(300)), PrestoDOM_Properties.orientation("vertical"), PrestoDOM_Properties.gravity("center-bottom"), PrestoDOM_Properties.background("#4E4B49") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(300)), PrestoDOM_Properties.orientation("horizontal"), PrestoDOM_Properties.gravity("center") ])([ PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)), PrestoDOM_Properties.margin("20,20,20,20"), PrestoDOM_Properties.background("#969696"), PrestoDOM_Properties.gravity("center"), PrestoDOM_Properties.visibility("not"), PrestoDOM_Properties.name("left"), PrestoDOM_Events.onClick(action.leftClick) ])([ PrestoDOM_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(25)), PrestoDOM_Properties.text("Left"), PrestoDOM_Properties.textSize("20") ]) ]), PrestoDOM_Elements.linearLayout([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)), PrestoDOM_Properties.margin("20,20,20,20"), PrestoDOM_Properties.background("#969696"), PrestoDOM_Properties.gravity("center"), PrestoDOM_Properties.visibility("not"), PrestoDOM_Properties.name("right"), PrestoDOM_Events.onClick(action.rightClick) ])([ PrestoDOM_Elements.textView([ PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)), PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(25)), PrestoDOM_Properties.text("Right"), PrestoDOM_Properties.textSize("20") ]) ]) ]), PrestoDOM_Elements.imageView([ PrestoDOM_Properties.height(new PrestoDOM_Types_DomAttributes.V(200)), PrestoDOM_Properties.width(new PrestoDOM_Types_DomAttributes.V(100)), PrestoDOM_Properties.imageUrl("car2"), PrestoDOM_Properties.translationX(Data_Show.show(Data_Show.showInt)(state.xPosition)), PrestoDOM_Properties.pivotY("350") ]) ]) ]) ]);
      };
  };
  var main = (function () {
      var validate = function (rClick) {
          return function (lClick) {
              return function (oldState) {
                  var $5 = rClick === true;
                  if ($5) {
                      var $6 = {};
                      for (var $7 in oldState) {
                          if ({}.hasOwnProperty.call(oldState, $7)) {
                              $6[$7] = oldState[$7];
                          };
                      };
                      $6.xPosition = oldState.xPosition + 50 | 0;
                      $6.yPosition = 350;
                      return $6;
                  };
                  var $9 = {};
                  for (var $10 in oldState) {
                      if ({}.hasOwnProperty.call(oldState, $10)) {
                          $9[$10] = oldState[$10];
                      };
                  };
                  $9.xPosition = oldState.xPosition - 50 | 0;
                  $9.yPosition = 350;
                  return $9;
              };
          };
      ...
      return function __do() {
          ...
          var v2 = PrestoDOM_Util.render(view({
              rightClick: v, 
              leftClick: v1
          }))(initialState)();
          return Control_Apply.applySecond(Control_Monad_Eff.applyEff)(v2.updateState(Control_Apply.apply(FRP_Behavior.applyABehavior(FRP_Event.functorEvent))(Control_Apply.apply(FRP_Behavior.applyABehavior(FRP_Event.functorEvent))(Data_Functor.map(FRP_Behavior.functorABehavior(FRP_Event.functorEvent))(validate)(Data_Lens_Getter.viewOn(v)(PrestoDOM_Core.beh)))(Data_Lens_Getter.viewOn(v1)(PrestoDOM_Core.beh)))(v2.stateBeh))(Control_Alt.alt(FRP_Event.altEvent)(Data_Lens_Getter.viewOn(v)(PrestoDOM_Core.ev))(Data_Lens_Getter.viewOn(v1)(PrestoDOM_Core.ev))))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit))();
      };
  })();
  exports["main"] = main;
  exports["view"] = view;
